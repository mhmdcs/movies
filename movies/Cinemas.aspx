            ...
            <ContentTemplate>
                ...
                <table class="nav-justified">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnMoviesAvailable" runat="server" OnClick="btnMoviesAvailable_Click" Text="SHOW ALL MOVIES AVAILABLE" Style="background-color: #9E4B77" BorderColor="#77395A" BorderStyle="Solid" Font-Bold="True" Font-Names="sans-serif" Font-Size="13px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 492px" class="modal-sm">&nbsp;</td>
