                    ...
                    <ContentTemplate>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="UserName" runat="server" style="background-color: #000000"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="Password" runat="server" TextMode="Password" style="background-color: #000000"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="ConfirmPassword" runat="server" TextMode="Password" style="background-color: #000000"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="Email" runat="server" style="background-color: #000000"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="Question" runat="server" style="background-color: #000000"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="Answer" runat="server" style="background-color: #000000"></asp:TextBox>
